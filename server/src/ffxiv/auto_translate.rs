...
lazy_static::lazy_static! {
    pub static ref AUTO_TRANSLATE: HashMap<(u32, u32), LocalisedText> = maplit::hashmap! {
        ...
        (56, 145) => LocalisedText {
            en: "Sleep",
            ja: "スリプル",
            de: "Schlaf",
            fr: "Sommeil",
        },
        (56, 146) => LocalisedText {
            en: "Blizzard II",
            ja: "ブリザラ",
            de: "Eisra",
            fr: "Extra Glace",
        ...
        (56, 164) => LocalisedText {
            en: "Bio",
            ja: "バイオ",
            de: "Bio",
            fr: "Bactérie",
        },
        (56, 165) => LocalisedText {
            en: "Summon",
            ja: "サモン",
            de: "Familiar",
            fr: "Invocation",
        ...
        (56, 168) => LocalisedText {
            en: "Miasma",
            ja: "ミアズマ",
            de: "Miasma",
            fr: "Miasmes",
        },
        (56, 170) => LocalisedText {
            en: "Summon II",
            ja: "サモンII",
            de: "Familiar II",
            fr: "Invocation II",
        ...
        (56, 174) => LocalisedText {
            en: "Bane",
            ja: "ベイン",
            de: "Bann",
            fr: "Fléau",
        },
        (56, 178) => LocalisedText {
            en: "Bio II",
            ja: "バイオラ",
            de: "Biora",
            fr: "Extra Bactérie",
        },
        (56, 180) => LocalisedText {
            en: "Summon III",
            ja: "サモンIII",
            de: "Familiar III",
            fr: "Invocation III",
        ...
        (56, 225) => LocalisedText {
            en: "Leaf Turn",
            ja: "リーフターン",
            de: "Höhere Ziele",
            fr: "Main verte",
        },
        (56, 226) => LocalisedText {
            en: "Leaf Turn II",
            ja: "リーフターンII",
            de: "Höhere Ziele II",
            fr: "Main verte II",
        ...
        (56, 242) => LocalisedText {
            en: "Unearth",
            ja: "アナース",
            de: "Exkavieren",
            fr: "Déterrage",
        },
        (56, 243) => LocalisedText {
            en: "Unearth II",
            ja: "アナースII",
            de: "Exkavieren II",
            fr: "Déterrage II",
        },
        (56, 252) => LocalisedText {
            en: "Inner Quiet",
            ja: "インナークワイエット",
            de: "Innere Ruhe",
            fr: "Calme intérieur",
        ...
        (56, 270) => LocalisedText {
            en: "Unearth III",
            ja: "アナースIII",
            de: "Exkavieren III",
            fr: "Déterrage III",
        },
        (56, 271) => LocalisedText {
            en: "Leaf Turn III",
            ja: "リーフターンIII",
            de: "Höhere Ziele III",
            fr: "Main verte III",
        ...
        (56, 274) => LocalisedText {
            en: "Nald'thal's Counsel",
            ja: "ナルザルの導き",
            de: "Nald'thals Führung",
            fr: "Signe de Nald'thal",
        },
        (56, 275) => LocalisedText {
            en: "Nophica's Counsel",
            ja: "ノフィカの導き",
            de: "Nophicas Führung",
            fr: "Signe de Nophica",
        },
        ...
        (56, 633) => LocalisedText {
            en: "Gouge",
            ja: "ひっかき",
            de: "Ausstemmen",
            fr: "Griffes",
        },
        (56, 634) => LocalisedText {
            en: "Shining Topaz",
            ja: "トパーズの輝き",
            de: "Glanztopas",
            fr: "Topaze scintillante",
        },
        (56, 637) => LocalisedText {
            en: "Gust",
            ja: "ガスト",
            de: "Böe",
            fr: "Coup de vent",
        },
        (56, 639) => LocalisedText {
            en: "Downburst",
            ja: "ダウンバースト",
            de: "Fallböe",
            fr: "Rafale descendante",
        },
        (56, 787) => LocalisedText {
            en: "Rock Buster",
            ja: "ロックバスター",
            de: "Steinsprenger",
            fr: "Casse-roc",
        },
        (56, 788) => LocalisedText {
            en: "Mountain Buster",
            ja: "マウンテンバスター",
            de: "Bergsprenger",
            fr: "Casse-montagnes",
        },
        (56, 791) => LocalisedText {
            en: "Earthen Fury",
            ja: "大地の怒り",
            de: "Gaias Zorn",
        ...
        (56, 794) => LocalisedText {
            en: "Aerial Slash",
            ja: "エリアルスラッシュ",
            de: "Lufthieb",
            fr: "Taillade aérienne",
        },
        (56, 796) => LocalisedText {
            en: "Aerial Blast",
            ja: "エリアルブラスト",
            de: "Windschlag",
            fr: "Rafale aérienne",
        },
        (56, 797) => LocalisedText {
            en: "Crimson Cyclone",
            ja: "クリムゾンサイクロン",
            de: "Zinnober-Zyklon",
            fr: "Cyclone écarlate",
        },
        (56, 798) => LocalisedText {
            en: "Burning Strike",
            ja: "バーニングストライク",
            de: "Brennender Schlag",
            fr: "Frappe ardente",
        },
        (56, 800) => LocalisedText {
            en: "Flaming Crush",
            ja: "フレイミングクラッシュ",
            de: "Flammenstoß",
            fr: "Fracassement flamboyant",
        },
        (56, 801) => LocalisedText {
            en: "Inferno",
            ja: "地獄の火炎",
            de: "Inferno",
        ...
        (56, 3604) => LocalisedText {
            en: "Diurnal Sect",
            ja: "ダイアーナルセクト",
            de: "Diurnal",
            fr: "Thème diurne",
        },
        (56, 3605) => LocalisedText {
            en: "Nocturnal Sect",
            ja: "ノクターナルセクト",
            de: "Nocturnal",
            fr: "Thème nocturne",
        ...
        (56, 4082) => LocalisedText {
            en: "Dredge",
            ja: "ドレッジ",
            de: "Ausschachtung",
            fr: "Dragage",
        },
        (56, 4083) => LocalisedText {
            en: "Dredge II",
            ja: "ドレッジII",
            de: "Ausschachtung II",
            fr: "Dragage II",
        ...
        (56, 4096) => LocalisedText {
            en: "Prune",
            ja: "プルーン",
            de: "Detrunkation",
            fr: "Élagage",
        },
        (56, 4097) => LocalisedText {
            en: "Prune II",
            ja: "プルーンII",
            de: "Detrunkation II",
            fr: "Élagage II",
        ...
        (56, 4605) => LocalisedText {
            en: "Mind of the Mountaineer",
            ja: "山師の技巧",
            de: "Finesse der Berge",
            fr: "Contenance du montagnard",
        },
        (56, 4606) => LocalisedText {
            en: "Mind of the Pioneer",
            ja: "開拓者の技巧",
            de: "Finesse der Felder",
            fr: "Contenance du pionnier",
        },
        (56, 4615) => LocalisedText {
        ...
        (56, 7423) => LocalisedText {
            en: "Aetherpact",
            ja: "エーテルパクト",
            de: "Ätherpakt",
            fr: "Pacte d'éther",
        },
        (56, 7424) => LocalisedText {
            en: "Bio III",
            ja: "バイオガ",
            de: "Bioga",
            fr: "Méga Bactérie",
        },
        (56, 7425) => LocalisedText {
            en: "Miasma III",
            ja: "ミアズガ",
            de: "Miasga",
            fr: "Méga Miasmes",
        ...
        (56, 7501) => LocalisedText {
            en: "Hissatsu: Seigan",
            ja: "必殺剣・星眼",
            de: "Hissatsu: Seigan",
            fr: "Hissatsu : Seigan",
        },
        (56, 7502) => LocalisedText {
            en: "Merciful Eyes",
            ja: "慈眼",
        ...
        (56, 16512) => LocalisedText {
            en: "Egi Assault II",
            ja: "エギアサルトII",
            de: "Egi-Attacke II",
            fr: "Frappe Egi II",
        },
        (56, 16513) => LocalisedText {
            en: "Firebird Trance",
            ja: "トランス・フェニックス",
            de: "Phönix-Trance",
            fr: "Transe-Phénix",
        ...
        (56, 16520) => LocalisedText {
            en: "Glittering Topaz",
            ja: "トパーズの煌き",
            de: "Glimmertopas",
            fr: "Éclat de topaze",
        },
        (56, 16521) => LocalisedText {
            en: "Glittering Emerald",
            ja: "エメラルドの煌き",
            de: "Glimmersmaragd",
            fr: "Éclat d'émeraude",
        },
        (56, 16522) => LocalisedText {
            en: "Earthen Armor",
            ja: "大地の鎧",
            de: "Gaia-Panzer",
            fr: "Armure tellurique",
        },
        (56, 16523) => LocalisedText {
            en: "Slipstream",
            ja: "スリップストリーム",
            de: "Wirbelströmung",
            fr: "Sillage",
        ...
        (56, 16791) => LocalisedText {
            en: "Assault I: Glittering Topaz",
            ja: "エギアサルトI：トパーズの煌き",
            de: "Egi-Attacke I: Glimmertopas",
            fr: "Frappe Egi I : Éclat de topaze",
        },
        (56, 16792) => LocalisedText {
            en: "Assault II: Shining Topaz",
            ja: "エギアサルトII：トパーズの輝き",
            de: "Egi-Attacke II: Glanztopas",
            fr: "Frappe Egi II : Topaze scintillante",
        },
        (56, 16793) => LocalisedText {
            en: "Assault I: Downburst",
            ja: "エギアサルトI：ダウンバースト",
            de: "Egi-Attacke I: Fallböe",
            fr: "Frappe Egi I : Rafale descendante",
        },
        (56, 16794) => LocalisedText {
            en: "Assault II: Glittering Emerald",
            ja: "エギアサルトII：エメラルドの煌き",
            de: "Egi-Attacke II: Glimmersmaragd",
            fr: "Frappe Egi II : Éclat d'émeraude",
        },
        (56, 16795) => LocalisedText {
            en: "Assault I: Earthen Armor",
            ja: "エギアサルトI：大地の鎧",
            de: "Egi-Attacke I: Gaia-Panzer",
            fr: "Frappe Egi I : Armure tellurique",
        },
        (56, 16796) => LocalisedText {
            en: "Assault II: Mountain Buster",
            ja: "エギアサルトII：マウンテンバスター",
            de: "Egi-Attacke II: Bergsprenger",
            fr: "Frappe Egi II : Casse-montagnes",
        },
        (56, 16797) => LocalisedText {
            en: "Assault I: Aerial Slash",
            ja: "エギアサルトI：エリアルスラッシュ",
            de: "Egi-Attacke I: Lufthieb",
            fr: "Frappe Egi I : Taillade aérienne",
        },
        (56, 16798) => LocalisedText {
            en: "Assault II: Slipstream",
            ja: "エギアサルトII：スリップストリーム",
            de: "Egi-Attacke II: Wirbelströmung",
            fr: "Frappe Egi II : Sillage",
        },
        (56, 16799) => LocalisedText {
            en: "Assault I: Crimson Cyclone",
            ja: "エギアサルトI：クリムゾンサイクロン",
            de: "Egi-Attacke I: Zinnober-Zyklon",
            fr: "Frappe Egi I : Cyclone écarlate",
        },
        (56, 16800) => LocalisedText {
            en: "Assault II: Flaming Crush",
            ja: "エギアサルトII：フレイミングクラッシュ",
            de: "Egi-Attacke II: Flammenstoß",
            fr: "Frappe Egi II : Fracassement flamboyant",
        },
        (56, 16801) => LocalisedText {
            en: "Enkindle: Earthen Fury",
            ja: "エンキンドル：大地の怒り",
            de: "Entflammung: Gaias Zorn",
            fr: "Galvanisation : Fureur tellurique",
        },
        (56, 16802) => LocalisedText {
            en: "Enkindle: Aerial Blast",
            ja: "エンキンドル：エリアルブラスト",
            de: "Entflammung: Windschlag",
            fr: "Galvanisation : Rafale aérienne",
        },
        (56, 16803) => LocalisedText {
            en: "Enkindle: Inferno",
            ja: "エンキンドル：地獄の火炎",
            de: "Entflammung: Inferno",
            fr: "Galvanisation : Flammes de l'enfer",
        },
        ...
        (63, 1584) => LocalisedText {
            en: "Purify",
            ja: "浄化",
            de: "Purifikation",
            fr: "Dépuration",
        },
        (63, 3359) => LocalisedText {
            en: "Aegis Boon",
            ja: "イージスブーン",
            de: "Ägidensegen",
            fr: "Égide",
        },
        (63, 3360) => LocalisedText {
            en: "Raw Destruction",
            ja: "ロウディストラクション",
            de: "Blindwütige Zerstörung",
            fr: "Destruction brutale",
        },
        (63, 3361) => LocalisedText {
            en: "Cometeor",
            ja: "コメテオ",
            de: "Cometeor",
            fr: "Cométéore",
        },
        (63, 3362) => LocalisedText {
            en: "Empyrean Rain",
            ja: "エンピリアンレイン",
            de: "Empyreischer Regen",
            fr: "Déluge empyréen",
        },
        (63, 4249) => LocalisedText {
            en: "Terminal Velocity",
            ja: "ターミナルベロシティ",
            de: "Terminierung",
            fr: "Vitesse terminale",
        },
        (63, 7855) => LocalisedText {
            en: "Hissatsu: Chiten",
            ja: "必殺剣・地天",
            de: "Hissatsu: Chiten",
            fr: "Hissatsu : Chiten",
        },
        (63, 7857) => LocalisedText {
            en: "Hissatsu: Soten",
            ja: "必殺剣・早天",
            de: "Hissatsu: Soten",
            fr: "Hissatsu : Sôten",
        },
        (63, 8746) => LocalisedText {
            en: "Fast Blade",
            ja: "ファストブレード",
            de: "Vortexschnitt",
            fr: "Lame rapide",
        },
        (63, 8749) => LocalisedText {
            en: "Riot Blade",
            ja: "ライオットソード",
            de: "Donnerklinge",
            fr: "Lame déchaînée",
        },
        (63, 8750) => LocalisedText {
            en: "Royal Authority",
            ja: "ロイヤルアソリティ",
            de: "Königsklinge",
            fr: "Autorité royale",
        },
        (63, 8752) => LocalisedText {
            en: "Holy Spirit",
            ja: "ホーリースピリット",
            de: "Heiliger Geist",
            fr: "Esprit saint",
        },
        (63, 8754) => LocalisedText {
            en: "Requiescat",
            ja: "レクイエスカット",
            de: "Requiescat",
            fr: "Requiescat",
        },
        (63, 8755) => LocalisedText {
            en: "Hallowed Ground",
            ja: "インビンシブル",
            de: "Heiliger Boden",
            fr: "Invincible",
        },
        (63, 8758) => LocalisedText {
            en: "Heavy Swing",
            ja: "ヘヴィスウィング",
            de: "Gewaltiger Hieb",
            fr: "Coup puissant",
        },
        (63, 8761) => LocalisedText {
            en: "Maim",
            ja: "メイム",
            de: "Verstümmelung",
            fr: "Mutilation",
        },
        (63, 8762) => LocalisedText {
            en: "Storm's Path",
            ja: "シュトルムヴィント",
            de: "Sturmkeil",
            fr: "Couperet de justice",
        },
        (63, 8763) => LocalisedText {
            en: "Fell Cleave",
            ja: "フェルクリーヴ",
            de: "Niedermähen",
            fr: "Sape-fendeur",
        },
        (63, 8764) => LocalisedText {
            en: "Tomahawk",
            ja: "トマホーク",
            de: "Tomahawk",
            fr: "Tomahawk",
        },
        (63, 8765) => LocalisedText {
            en: "Onslaught",
            ja: "オンスロート",
            de: "Sturmlauf",
            fr: "Assaut violent",
        },
        (63, 8767) => LocalisedText {
            en: "Holmgang",
            ja: "ホルムギャング",
            de: "Holmgang",
            fr: "Holmgang",
        },
        (63, 8768) => LocalisedText {
            en: "Inner Release",
            ja: "原初の解放",
            de: "Urbefreiung",
            fr: "Relâchement bestial",
        },
        (63, 8769) => LocalisedText {
            en: "Hard Slash",
            ja: "ハードスラッシュ",
            de: "Harter Schlitzer",
            fr: "Taillade violente",
        ...
        (63, 8773) => LocalisedText {
            en: "Souleater",
            ja: "ソウルイーター",
            de: "Seelenfresser",
            fr: "Dévoreur d'âme",
        },
        (63, 8775) => LocalisedText {
            en: "Unmend",
            ja: "アンメンド",
            de: "Zerfall",
            fr: "Détérioration",
        },
        (63, 8776) => LocalisedText {
            en: "Bloodspiller",
            ja: "ブラッドスピラー",
            de: "Blutvergießen",
            fr: "Marée de sang",
        },
        (63, 8777) => LocalisedText {
            en: "Plunge",
            ja: "プランジカット",
            de: "Hiebsprung",
            fr: "Coupe plongeante",
        },
        (63, 8779) => LocalisedText {
            en: "The Blackest Night",
            ja: "ブラックナイト",
            de: "Schwärzeste Nacht",
            fr: "Nuit noirissime",
        },
        (63, 8780) => LocalisedText {
            en: "Bootshine",
            ja: "連撃",
            de: "Schlag auf Schlag",
            fr: "Volée de coups",
        },
        (63, 8781) => LocalisedText {
            en: "True Strike",
            ja: "正拳突き",
            de: "Wahrer Schlag",
            fr: "Coup de poing direct",
        },
        (63, 8782) => LocalisedText {
            en: "Snap Punch",
            ja: "崩拳",
            de: "Peitschenhieb",
            fr: "Coup de poing brusque",
        },
        (63, 8787) => LocalisedText {
            en: "Shoulder Tackle",
            ja: "羅刹衝",
            de: "Rakshasas Umarmung",
            fr: "Coup d'épaule",
        },
        (63, 8788) => LocalisedText {
            en: "Riddle of Earth",
            ja: "金剛の極意",
            de: "Steinernes Enigma",
            fr: "Énigme de la terre",
        },
        (63, 8789) => LocalisedText {
            en: "Tornado Kick",
            ja: "闘魂旋風脚",
            de: "Tornadotritt",
            fr: "Coup de pied tornade",
        },
        (63, 8790) => LocalisedText {
            en: "The Forbidden Chakra",
            ja: "陰陽闘気斬",
            de: "Verbotenes Chakra",
            fr: "Chakra interdit",
        },
        (63, 8793) => LocalisedText {
            en: "Full Thrust",
            ja: "フルスラスト",
            de: "Ungebremster Stoß",
            fr: "Percée totale",
        },
        (63, 8794) => LocalisedText {
            en: "Fang and Claw",
            ja: "竜牙竜爪",
            de: "Fang und Klaue",
            fr: "Croc-et-griffe",
        },
        (63, 8798) => LocalisedText {
            en: "Wheeling Thrust",
            ja: "竜尾大車輪",
            de: "Fächerstoß",
            fr: "Percée tournante",
        },
        (63, 8799) => LocalisedText {
            en: "Piercing Talon",
            ja: "ピアシングタロン",
            de: "Reißende Klauen",
            fr: "Griffe perçante",
        },
        (63, 8802) => LocalisedText {
            en: "Spineshatter Dive",
            ja: "スパインダイブ",
            de: "Wirbelsprenger",
            fr: "Piqué brise-échine",
        },
        (63, 8803) => LocalisedText {
            en: "Elusive Jump",
            ja: "イルーシブジャンプ",
            de: "Ausweichsprung",
            fr: "Saut insaisissable",
        },
        (63, 8805) => LocalisedText {
            en: "Geirskogul",
            ja: "ゲイルスコグル",
            de: "Geirskogul",
            fr: "Geirskögul",
        },
        (63, 8806) => LocalisedText {
            en: "Nastrond",
            ja: "ナーストレンド",
            de: "Nastrond",
            fr: "Naströnd",
        },
        (63, 8807) => LocalisedText {
            en: "Spinning Edge",
            ja: "双刃旋",
            de: "Wirbelklinge",
            fr: "Lame tournoyante",
        },
        (63, 8808) => LocalisedText {
            en: "Gust Slash",
            ja: "風断ち",
            de: "Windschlitzer",
            fr: "Tourbillon tailladant",
        },
        (63, 8809) => LocalisedText {
            en: "Aeolian Edge",
            ja: "旋風刃",
            de: "Äolusklinge",
            fr: "Lame éolienne",
        },
        (63, 8811) => LocalisedText {
            en: "Throwing Dagger",
            ja: "投刃",
            de: "Wurfmesser",
            fr: "Dagues de jet",
        },
        (63, 8812) => LocalisedText {
            en: "Shukuchi",
            ja: "縮地",
            de: "Shukuchi",
            fr: "Shukuchi",
        },
        (63, 8814) => LocalisedText {
            en: "Assassinate",
            ja: "終撃",
            de: "Meuchelsprung",
            fr: "Assassinement",
        },
        (63, 8815) => LocalisedText {
            en: "Bhavacakra",
            ja: "六道輪廻",
            de: "Rad des Werdens",
            fr: "Bhavacakra",
        },
        (63, 8816) => LocalisedText {
            en: "Three Mudra",
            ja: "三印自在",
            de: "Tri-Mudra",
            fr: "Trimudrâ",
        },
        (63, 8820) => LocalisedText {
            en: "Kakuremi",
            ja: "隠身の術",
            de: "Kakuremi",
            fr: "Kakuremi",
        },
        (63, 8824) => LocalisedText {
            en: "Yukikaze",
            ja: "雪風",
            de: "Yukikaze",
            fr: "Yukikaze",
        },
        (63, 8825) => LocalisedText {
            en: "Gekko",
            ja: "月光",
            de: "Gekko",
            fr: "Gekkô",
        },
        (63, 8826) => LocalisedText {
            en: "Kasha",
            ja: "花車",
            de: "Kasha",
            fr: "Kasha",
        },
        (63, 8827) => LocalisedText {
            en: "Enpi",
            ja: "燕飛",
            de: "Enpi",
            fr: "Enpi",
        },
        (63, 8830) => LocalisedText {
            en: "Tenka Goken",
            ja: "天下五剣",
            de: "Tenka Goken",
            fr: "Tenka Goken",
        },
        (63, 8831) => LocalisedText {
            en: "Midare Setsugekka",
            ja: "乱れ雪月花",
            de: "Midare Setsugekka",
            fr: "Midare Setsugekka",
        },
        (63, 8832) => LocalisedText {
            en: "Hissatsu: Shinten",
            ja: "必殺剣・震天",
            de: "Hissatsu: Shinten",
            fr: "Hissatsu : Shinten",
        },
        (63, 8838) => LocalisedText {
            en: "Empyreal Arrow",
            ja: "エンピリアルアロー",
            de: "Empyreischer Pfeil",
            fr: "Flèche empyréenne",
        },
        (63, 8839) => LocalisedText {
            en: "Repelling Shot",
            ja: "リペリングショット",
            de: "Mannstopper",
            fr: "Tir repoussant",
        },
        (63, 8841) => LocalisedText {
            en: "Sidewinder",
            ja: "サイドワインダー",
            de: "Seitenschneider",
            fr: "Vent venimeux",
        },
        (63, 8842) => LocalisedText {
            en: "Pitch Perfect",
            ja: "ピッチパーフェクト",
            de: "Absolutes Gehör",
            fr: "Ton parfait",
        },
        (63, 8843) => LocalisedText {
            en: "The Wanderer's Minuet",
            ja: "旅神のメヌエット",
            de: "Menuett des Wanderers",
            fr: "Menuet du Vagabond",
        },
        (63, 8844) => LocalisedText {
            en: "Army's Paeon",
            ja: "軍神のパイオン",
            de: "Hymne der Krieger",
            fr: "Péan martial",
        },
        (63, 8848) => LocalisedText {
            en: "Heated Split Shot",
            ja: "ヒートスプリットショット",
            de: "Höllenfeuer frei",
            fr: "Tir scindé chauffé",
        },
        (63, 8849) => LocalisedText {
            en: "Heated Slug Shot",
            ja: "ヒートスラッグショット",
            de: "Höllen-Flintenlaufgeschoss",
            fr: "Tir de balle chauffé",
        },
        (63, 8850) => LocalisedText {
            en: "Heated Clean Shot",
            ja: "ヒートクリーンショット",
            de: "Sauberer Höllenschuss",
            fr: "Tir net chauffé",
        },
        (63, 8851) => LocalisedText {
            en: "Heat Blast",
            ja: "ヒートブラスト",
            de: "Hitzeschuss",
            fr: "Pyro-explosion",
        },
        (63, 8853) => LocalisedText {
            en: "Blank",
            ja: "ブランク",
            de: "Böller",
            fr: "Tir à blanc",
        },
        (63, 8855) => LocalisedText {
            en: "Wildfire",
            ja: "ワイルドファイア",
            de: "Wildfeuer",
            fr: "Flambée",
        },
        (63, 8858) => LocalisedText {
            en: "Fire",
            ja: "ファイア",
            de: "Feuer",
            fr: "Feu",
        },
        (63, 8859) => LocalisedText {
            en: "Blizzard",
            ja: "ブリザド",
            de: "Eis",
            fr: "Glace",
        },
        (63, 8860) => LocalisedText {
            en: "Thunder",
            ja: "サンダー",
            de: "Blitz",
            fr: "Foudre",
        },
        (63, 8861) => LocalisedText {
            en: "Thunder III",
            ja: "サンダガ",
            de: "Blitzga",
            fr: "Méga Foudre",
        },
        (63, 8862) => LocalisedText {
            en: "Enochian",
            ja: "エノキアン",
            de: "Henochisch",
            fr: "Énochien",
        },
        (63, 8863) => LocalisedText {
            en: "Fire IV",
            ja: "ファイジャ",
            de: "Feuka",
            fr: "Giga Feu",
        },
        (63, 8864) => LocalisedText {
            en: "Blizzard IV",
            ja: "ブリザジャ",
            de: "Eiska",
            fr: "Giga Glace",
        },
        (63, 8865) => LocalisedText {
            en: "Foul",
            ja: "ファウル",
            de: "Moder",
            fr: "Infect",
        },
        (63, 8866) => LocalisedText {
            en: "Flare",
            ja: "フレア",
            de: "Flare",
            fr: "Brasier",
        },
        (63, 8867) => LocalisedText {
            en: "Freeze",
            ja: "フリーズ",
            de: "Einfrieren",
            fr: "Gel",
        },
        (63, 8869) => LocalisedText {
            en: "Aetherial Manipulation",
            ja: "エーテリアルステップ",
            de: "Äthermanipulation",
            fr: "Manipulation de l'éther",
        },
        (63, 8872) => LocalisedText {
            en: "Ruin III",
            ja: "ルインガ",
            de: "Ruinga",
            fr: "Méga Ruine",
        },
        (63, 8873) => LocalisedText {
            en: "Bio III",
            ja: "バイオガ",
            de: "Bioga",
            fr: "Méga Bactérie",
        },
        (63, 8877) => LocalisedText {
            en: "Fester",
            ja: "ミアズマバースト",
            de: "Schwäre",
            fr: "Suppuration",
        },
        (63, 8882) => LocalisedText {
            en: "Veraero",
            ja: "ヴァルエアロ",
            de: "Erzwind",
            fr: "VerVent",
        },
        (63, 8883) => LocalisedText {
            en: "Verstone",
            ja: "ヴァルストーン",
            de: "Erzstein",
            fr: "VerTerre",
        },
        (63, 8884) => LocalisedText {
            en: "Verthunder",
            ja: "ヴァルサンダー",
            de: "Erzblitz",
            fr: "VerFoudre",
        },
        (63, 8885) => LocalisedText {
            en: "Verfire",
            ja: "ヴァルファイア",
            de: "Erzfeuer",
            fr: "VerFeu",
        },
        (63, 8886) => LocalisedText {
            en: "Impact",
            ja: "インパクト",
            de: "Impakt",
            fr: "Impact",
        },
        (63, 8887) => LocalisedText {
            en: "Enchanted Riposte",
            ja: "エンリポスト",
            de: "Magische Riposte",
            fr: "Riposte enchantée",
        },
        (63, 8888) => LocalisedText {
            en: "Enchanted Zwerchhau",
            ja: "エンツヴェルクハウ",
            de: "Magischer Zwerchhau",
            fr: "Zwerchhau enchanté",
        },
        (63, 8889) => LocalisedText {
            en: "Enchanted Redoublement",
            ja: "エンルドゥブルマン",
            de: "Magisches Redoublement",
            fr: "Redoublement enchanté",
        },
        (63, 8890) => LocalisedText {
            en: "Corps-a-corps",
            ja: "コル・ア・コル",
            de: "Corps-a-corps",
            fr: "Corps-à-corps",
        },
        (63, 8891) => LocalisedText {
            en: "Displacement",
            ja: "デプラスマン",
            de: "Körperparade",
            fr: "Déplacement",
        },
        (63, 8895) => LocalisedText {
            en: "Cure",
            ja: "ケアル",
            de: "Vita",
            fr: "Soin",
        },
        (63, 8896) => LocalisedText {
            en: "Cure II",
            ja: "ケアルラ",
            de: "Vitra",
            fr: "Extra Soin",
        },
        (63, 8904) => LocalisedText {
            en: "Physick",
            ja: "フィジク",
            de: "Physick",
            fr: "Médecine",
        },
        (63, 8905) => LocalisedText {
            en: "Adloquium",
            ja: "鼓舞激励の策",
            de: "Adloquium",
            fr: "Traité du réconfort",
        },
        (63, 8909) => LocalisedText {
            en: "Lustrate",
            ja: "生命活性法",
            de: "Revitalisierung",
            fr: "Loi de revivification",
        },
        (63, 8913) => LocalisedText {
            en: "Benefic",
            ja: "ベネフィク",
            de: "Harmonieaspekt",
            fr: "Bienfaisance",
        },
        (63, 8914) => LocalisedText {
            en: "Benefic II",
            ja: "ベネフィラ",
            de: "Harmonieaspekt II",
            fr: "Bienfaisance II",
        },
        (63, 8916) => LocalisedText {
            en: "Essential Dignity",
            ja: "ディグニティ",
            de: "Essenzielle Würde",
            fr: "Dignité essentielle",
        },
        (63, 9013) => LocalisedText {
            en: "Dreadwyrm Trance",
            ja: "トランス・バハムート",
            de: "Bahamut-Trance",
            fr: "Transe-Bahamut",
        },
        (63, 9014) => LocalisedText {
            en: "Deathflare",
            ja: "デスフレア",
            de: "Todesflamme",
            fr: "Brasier de mort",
        },
        (63, 9433) => LocalisedText {
            en: "Verholy",
            ja: "ヴァルホーリー",
            de: "Erz-Sanctus",
            fr: "VerMiracle",
        },
        (63, 9434) => LocalisedText {
            en: "Verflare",
            ja: "ヴァルフレア",
            de: "Erzflare",
            fr: "VerBrasier",
        },
        (63, 9620) => LocalisedText {
            en: "Assize",
            ja: "アサイズ",
            de: "Assise",
            fr: "Assises",
        },
        (63, 9639) => LocalisedText {
            en: "Riddle of Fire",
            ja: "紅蓮の極意",
            de: "Flammendes Enigma",
            fr: "Énigme du feu",
        },
        (63, 10025) => LocalisedText {
            en: "Vercure",
            ja: "ヴァルケアル",
            de: "Erzvita",
            fr: "VerSoin",
        },
        (63, 10027) => LocalisedText {
            en: "Minor Arcana",
            ja: "マイナーアルカナ",
            de: "Kleine Arkana",
            fr: "Arcane mineur",
        },
        (63, 10028) => LocalisedText {
            en: "Lord of Crowns",
            ja: "クラウンロード",
            de: "König der Kronen",
            fr: "Roi des couronnes",
        },
        (63, 10029) => LocalisedText {
            en: "Lady of Crowns",
            ja: "クラウンレディ",
            de: "Königin der Kronen",
            fr: "Reine des couronnes",
        },
        (63, 10032) => LocalisedText {
            en: "Dragon Sight",
            ja: "ドラゴンサイト",
            de: "Drachenblick",
            fr: "Vue de dragon",
        },
        (63, 13975) => LocalisedText {
            en: "Tetragrammaton",
            ja: "テトラグラマトン",
            de: "Tetragrammaton",
            fr: "Tétragramme",
        },
        (63, 17669) => LocalisedText {
            en: "Low Blow",
            ja: "ロウブロウ",
            de: "Tiefschlag",
            fr: "Coup bas",
        },
        (63, 17670) => LocalisedText {
            en: "Axe Kick",
            ja: "かかと落とし",
            de: "Axttritt",
            fr: "Coup de pied retombant",
        },
        (63, 17671) => LocalisedText {
            en: "Full Swing",
            ja: "フルスイング",
            de: "Voller Schwinger",
            fr: "Plein élan",
        },
        (63, 17672) => LocalisedText {
            en: "Rampart",
            ja: "ランパート",
            de: "Schutzwall",
            fr: "Rempart",
        },
        (63, 17674) => LocalisedText {
            en: "Backstep",
            ja: "バックステップ",
            de: "Zurückweichen",
            fr: "Pas arrière",
        },
        (63, 17676) => LocalisedText {
            en: "Bloodbath",
            ja: "ブラッドバス",
            de: "Blutbad",
            fr: "Bain de sang",
        },
        (63, 17677) => LocalisedText {
            en: "Fetter Ward",
            ja: "フェターウォード",
            de: "Obhut",
            fr: "Émancipation",
        },
        (63, 17678) => LocalisedText {
            en: "Leg Graze",
            ja: "レッググレイズ",
            de: "Beinschuss",
            fr: "Écorche-jambe",
        },
        (63, 17679) => LocalisedText {
            en: "Foot Graze",
            ja: "フットグレイズ",
            de: "Stolperschuss",
            fr: "Écorche-pied",
        },
        (63, 17680) => LocalisedText {
            en: "Head Graze",
            ja: "ヘッドグレイズ",
            de: "Haarscharfer Schuss",
            fr: "Écorche-tête",
        },
        (63, 17681) => LocalisedText {
            en: "Arm's Length",
            ja: "アームズレングス",
            de: "Abtausch",
            fr: "Portée de bras",
        },
        (63, 17682) => LocalisedText {
            en: "Peloton",
            ja: "プロトン",
            de: "Peloton",
            fr: "Peloton",
        },
        (63, 17683) => LocalisedText {
            en: "Drain",
            ja: "ドレイン",
            de: "Aussaugen",
            fr: "Drain",
        },
        (63, 17684) => LocalisedText {
            en: "Phantom Dart",
            ja: "ファントムダート",
            de: "Phantompfeil",
            fr: "Projectile fantôme",
        },
        (63, 17685) => LocalisedText {
            en: "Swiftcast",
            ja: "迅速魔",
            de: "Spontaneität",
            fr: "Magie prompte",
        },
        (63, 17686) => LocalisedText {
            en: "Addle",
            ja: "アドル",
            de: "Stumpfsinn",
            fr: "Embrouillement",
        },
        (63, 17687) => LocalisedText {
            en: "Manaward",
            ja: "マバリア",
            de: "Mana-Schild",
            fr: "Barrière de mana",
        },
        (63, 17688) => LocalisedText {
            en: "Rescue",
            ja: "救出",
            de: "Rettung",
            fr: "Secours",
        },
        (63, 17689) => LocalisedText {
            en: "Attunement",
            ja: "調和",
            de: "Gleichgewicht",
            fr: "Harmonie",
        },
        (63, 17690) => LocalisedText {
            en: "Repose",
            ja: "リポーズ",
            de: "Schlummer",
            fr: "Sérénité",
        },
        (63, 17691) => LocalisedText {
            en: "Atonement",
            ja: "ロイエ",
            de: "Absolution",
            fr: "Absolution",
        },
        (63, 17692) => LocalisedText {
            en: "Confiteor",
            ja: "コンフィテオル",
            de: "Confiteor",
            fr: "Confiteor",
        ...
        (63, 17694) => LocalisedText {
            en: "Intervene",
            ja: "インターヴィーン",
            de: "Einschreiten",
            fr: "Irruption brutale",
        },
        (63, 17695) => LocalisedText {
            en: "Decimate",
            ja: "デシメート",
            de: "Dezimieren",
            fr: "Décimation",
        },
        (63, 17696) => LocalisedText {
            en: "Inner Chaos",
            ja: "インナーカオス",
            de: "Inneres Chaos",
            fr: "Chaos intérieur",
        },
        (63, 17697) => LocalisedText {
            en: "Chaotic Cyclone",
            ja: "カオティックサイクロン",
            de: "Chaosklinge",
            fr: "Cyclone chaotique",
        },
        (63, 17698) => LocalisedText {
            en: "Infuriate",
            ja: "ウォークライ",
            de: "Schlachtruf",
            fr: "Cri de guerre",
        },
        (63, 17699) => LocalisedText {
            en: "Shake It Off",
            ja: "シェイクオフ",
            de: "Abschütteln",
            fr: "Débarrassage",
        },
        (63, 17700) => LocalisedText {
            en: "Quietus",
            ja: "クワイタス",
            de: "Quietus",
            fr: "Quietus",
        },
        (63, 17701) => LocalisedText {
            en: "Edge of Shadow",
            ja: "漆黒の剣",
            de: "Schattenklinge",
            fr: "Tranchant d'ombre",
        },
        (63, 17702) => LocalisedText {
            en: "Delirium",
            ja: "ブラッドデリリアム",
            de: "Blutdelirium",
            fr: "Delirium de sang",
        },
        (63, 17703) => LocalisedText {
            en: "Keen Edge",
            ja: "キーンエッジ",
            de: "Zerfetzer",
            fr: "Tranchant acéré",
        },
        (63, 17704) => LocalisedText {
            en: "Brutal Shell",
            ja: "ブルータルシェル",
            de: "Brutaler Einschlag",
            fr: "Impact brutal",
        },
        (63, 17705) => LocalisedText {
            en: "Solid Barrel",
            ja: "ソリッドバレル",
            de: "Stahlwalze",
            fr: "Salve tranchante",
        },
        (63, 17706) => LocalisedText {
            en: "Gnashing Fang",
            ja: "ビートファング",
            de: "Schlagfänge",
            fr: "Croc pugnace",
        },
        (63, 17707) => LocalisedText {
            en: "Savage Claw",
            ja: "サベッジクロウ",
            de: "Wilde Klauen",
            fr: "Griffe sauvage",
        },
        (63, 17708) => LocalisedText {
            en: "Wicked Talon",
            ja: "ウィケッドタロン",
            de: "Tückische Kralle",
            fr: "Serre vicieuse",
        },
        (63, 17709) => LocalisedText {
            en: "Burst Strike",
            ja: "バーストストライク",
            de: "Explosiver Stoß",
            fr: "Frappe explosive",
        },
        (63, 17710) => LocalisedText {
            en: "Fated Circle",
            ja: "フェイテッドサークル",
            de: "Schicksalszirkel",
            fr: "Atomiseur",
        },
        (63, 17711) => LocalisedText {
            en: "Continuation",
            ja: "コンティニュエーション",
            de: "Triggerfolge",
            fr: "Consécution",
        },
        (63, 17712) => LocalisedText {
            en: "Jugular Rip",
            ja: "ジャギュラーリップ",
            de: "Kehlreißer",
            fr: "Arrachage de la jugulaire",
        },
        (63, 17713) => LocalisedText {
            en: "Abdomen Tear",
            ja: "アブドメンテアー",
            de: "Bauchschlitzer",
            fr: "Lacération de l'abdomen",
        },
        (63, 17714) => LocalisedText {
            en: "Eye Gouge",
            ja: "アイガウジ",
            de: "Augenstecher",
            fr: "Perforation des yeux",
        },
        (63, 17716) => LocalisedText {
            en: "Rough Divide",
            ja: "ラフディバイド",
            de: "Grobspalter",
            fr: "Lamineur",
        },
        (63, 17717) => LocalisedText {
            en: "Lightning Shot",
            ja: "サンダーバレット",
            de: "Donnerkugel",
            fr: "Barillet tonnerre",
        },
        (63, 17719) => LocalisedText {
            en: "Six-sided Star",
            ja: "六合星導脚",
            de: "Sechsstern-Tritt",
            fr: "Étoile à six branches",
        },
        (63, 17720) => LocalisedText {
            en: "Enlightenment",
            ja: "万象闘気圏",
            de: "Weg zur Erleuchtung",
            fr: "Illumination",
        },
        (63, 17727) => LocalisedText {
            en: "Scatter",
            ja: "スキャッター",
            de: "Zerstreuen",
            fr: "Éparpillement",
        },
        (63, 17728) => LocalisedText {
            en: "High Jump",
            ja: "ハイジャンプ",
            de: "Hochsprung",
            fr: "Grand saut",
        },
        (63, 17729) => LocalisedText {
            en: "Stardiver",
            ja: "スターダイバー",
            de: "Sternensturz",
            fr: "Plongeon céleste",
        },
        (63, 17730) => LocalisedText {
            en: "Mirage Dive",
            ja: "ミラージュダイブ",
            de: "Illusionssprung",
            fr: "Piqué mirage",
        },
        (63, 17731) => LocalisedText {
            en: "Hellfrog Medium",
            ja: "口寄せの術・大蝦蟇",
            de: "Krötenmedium",
            fr: "Kuchiyose Ogama",
        },
        (63, 17732) => LocalisedText {
            en: "Goka Mekkyaku",
            ja: "劫火滅却の術",
            de: "Goka Mekkyaku",
            fr: "Gôka Mekkyaku",
        },
        (63, 17733) => LocalisedText {
            en: "Hyosho Ranryu",
            ja: "氷晶乱流の術",
            de: "Hyosho Ranryu",
            fr: "Hyôshô Ranryû",
        },
        (63, 17734) => LocalisedText {
            en: "Bunshin",
            ja: "分身の術",
            de: "Doppeltes Ich",
            fr: "Bunshin",
        },
        (63, 17735) => LocalisedText {
            en: "Trick Attack",
            ja: "だまし討ち",
            de: "Trickattacke",
            fr: "Attaque sournoise",
        },
        (63, 17740) => LocalisedText {
            en: "Tsubame-gaeshi",
            ja: "燕返し",
            de: "Tsubamegaeshi",
            fr: "Tsubamegaeshi",
        },
        (63, 17742) => LocalisedText {
            en: "Kaeshi: Goken",
            ja: "返し五剣",
            de: "Kaeshi Goken",
            fr: "Kaeshi Goken",
        },
        (63, 17743) => LocalisedText {
            en: "Kaeshi: Setsugekka",
            ja: "返し雪月花",
            de: "Kaeshi Setsugekka",
            fr: "Kaeshi Setsugekka",
        },
        (63, 17745) => LocalisedText {
            en: "Burst Shot",
            ja: "バーストショット",
            de: "Berstender Schuss",
            fr: "Tir éclatant",
        },
        (63, 17747) => LocalisedText {
            en: "Apex Arrow",
            ja: "エイペックスアロー",
            de: "Apex-Pfeil",
            fr: "Trait alpha",
        },
        (63, 17748) => LocalisedText {
            en: "Bow Shock",
            ja: "バウショック",
            de: "Schockpatrone",
            fr: "Arc de choc",
        },
        (63, 17749) => LocalisedText {
            en: "Drill",
            ja: "ドリル",
            de: "Bohrer",
            fr: "Foreuse",
        },
        (63, 17750) => LocalisedText {
            en: "Air Anchor",
            ja: "エアアンカー",
            de: "Luftanker",
            fr: "Ancre aérienne",
        },
        (63, 17751) => LocalisedText {
            en: "Auto Crossbow",
            ja: "オートボウガン",
            de: "Armbrust",
            fr: "Arbalète automatique",
        },
        (63, 17752) => LocalisedText {
            en: "Bioblaster",
            ja: "バイオブラスト",
            de: "Bioblaster",
            fr: "Lance-toxine",
        },
        (63, 17753) => LocalisedText {
            en: "Ricochet",
            ja: "リコシェット",
            de: "Rikoschettschuss",
            fr: "Ricochet",
        },
        (63, 17754) => LocalisedText {
            en: "Hypercharge",
            ja: "ハイパーチャージ",
            de: "Hyperladung",
            fr: "Hypercharge",
        },
        (63, 17756) => LocalisedText {
            en: "Cascade",
            ja: "カスケード",
            de: "Cascade",
            fr: "Cascade",
        },
        (63, 17757) => LocalisedText {
            en: "Fountain",
            ja: "ファウンテン",
            de: "Fontäne",
            fr: "Fontaine",
        },
        (63, 17758) => LocalisedText {
            en: "Reverse Cascade",
            ja: "リバースカスケード",
            de: "Invertierte Cascade",
            fr: "Cascade inversée",
        },
        (63, 17759) => LocalisedText {
            en: "Fountainfall",
            ja: "ファウンテンフォール",
            de: "Fallende Fontäne",
            fr: "Fontaine en cascade",
        },
        (63, 17760) => LocalisedText {
            en: "Saber Dance",
            ja: "剣の舞い",
            de: "Schwerttanz",
            fr: "Danse du sabre",
        },
        (63, 17761) => LocalisedText {
            en: "Fan Dance",
            ja: "扇の舞い【序】",
            de: "Fächertanz I",
            fr: "Danse de l'éventail I",
        },
        (63, 17762) => LocalisedText {
            en: "Fan Dance III",
            ja: "扇の舞い【急】",
            de: "Fächertanz III",
            fr: "Danse de l'éventail III",
        },
        (63, 17763) => LocalisedText {
            en: "Curing Waltz",
            ja: "癒やしのワルツ",
            de: "Heilender Walzer",
            fr: "Valse revigorante",
        },
        (63, 17764) => LocalisedText {
            en: "En Avant",
            ja: "アン・アヴァン",
            de: "En Avant",
            fr: "En avant",
        },
        (63, 17765) => LocalisedText {
            en: "Closed Position",
            ja: "クローズドポジション",
            de: "Tanzpartner",
            fr: "Position rapprochée",
        },
        (63, 17766) => LocalisedText {
            en: "Standard Step",
            ja: "スタンダードステップ",
            de: "Einfache Choreographie",
            fr: "Pas classique",
        },
        (63, 17767) => LocalisedText {
            en: "Emboite",
            ja: "薔薇のアンボワテ",
            de: "Pas Emboite der Rose",
            fr: "Emboîté carmin",
        },
        (63, 17768) => LocalisedText {
            en: "Entrechat",
            ja: "小鳥のアントルシャ",
            de: "Entrechat der Schwalbe",
            fr: "Entrechat outremer",
        },
        (63, 17769) => LocalisedText {
            en: "Jete",
            ja: "緑葉のジュテ",
            de: "Jete des Laubs",
            fr: "Jeté verdoyant",
        },
        (63, 17770) => LocalisedText {
            en: "Pirouette",
            ja: "金冠のピルエッテ",
            de: "Pirouette der Krone",
            fr: "Pirouette dorée",
        },
        (63, 17771) => LocalisedText {
            en: "Standard Finish",
            ja: "スタンダードフィニッシュ",
            de: "Einfaches Finale",
            fr: "Final classique",
        },
        (63, 17774) => LocalisedText {
            en: "Xenoglossy",
            ja: "ゼノグロシー",
            de: "Xenoglossie",
            fr: "Xénoglossie",
        },
        (63, 17775) => LocalisedText {
            en: "Night Wing",
            ja: "ナイトウィング",
            de: "Nachtschwinge",
            fr: "Aile nocturne",
        },
        (63, 17777) => LocalisedText {
            en: "Energy Drain",
            ja: "エナジードレイン",
            de: "Energieentzug",
            fr: "Aspiration d'énergie",
        ...
        (63, 17779) => LocalisedText {
            en: "Brand of Purgatory",
            ja: "煉獄の炎",
            de: "Zeichen der Läuterung",
            fr: "Tison du purgatoire",
        },
        (63, 17780) => LocalisedText {
            en: "Wither",
            ja: "ウィザー",
            de: "Entkräften",
            fr: "Flétrissure",
        },
        (63, 17781) => LocalisedText {
            en: "Firebird Trance",
            ja: "トランス・フェニックス",
            de: "Phönix-Trance",
            fr: "Transe-Phénix",
        },
        (63, 17786) => LocalisedText {
            en: "Engagement",
            ja: "アンガジェマン",
            de: "Arret-Stoß",
            fr: "Engagement",
        },
        (63, 17787) => LocalisedText {
            en: "Scorch",
            ja: "スコーチ",
            de: "Versengung",
            fr: "Calcination",
        },
        (63, 17788) => LocalisedText {
            en: "Enchanted Reprise",
            ja: "エンルプリーズ",
            de: "Magische Reprise",
            fr: "Reprise enchantée",
        },
        (63, 17789) => LocalisedText {
            en: "Glare",
            ja: "グレア",
            de: "Blendung",
            fr: "Chatoiement",
        },
        (63, 17790) => LocalisedText {
            en: "Dia",
            ja: "ディア",
            de: "Dia",
            fr: "Lumen",
        },
        (63, 17791) => LocalisedText {
            en: "Afflatus Solace",
            ja: "ハート・オブ・ソラス",
            de: "Afflatus solatii",
            fr: "Offrande de réconfort",
        },
        (63, 17793) => LocalisedText {
            en: "Afflatus Misery",
            ja: "ハート・オブ・ミゼリ",
            de: "Afflatus miseriae",
            fr: "Offrande de misère",
        },
        (63, 17794) => LocalisedText {
            en: "Temperance",
            ja: "テンパランス",
            de: "Linderung",
            fr: "Tempérance",
        },
        (63, 17795) => LocalisedText {
            en: "Broil III",
            ja: "死炎法",
            de: "Vernichtende Bravade",
            fr: "Loi de l'ébullition III",
        },
        (63, 17796) => LocalisedText {
            en: "Biolysis",
            ja: "蠱毒法",
            de: "Causae et Curae",
            fr: "Loi de l'infection",
        },
        (63, 17797) => LocalisedText {
            en: "Aura Blast",
            ja: "生命波動法",
            de: "Auratische Resonanz",
            fr: "Détonation d'aura",
        },
        (63, 17804) => LocalisedText {
            en: "Aspected Benefic",
            ja: "アスペクト・ベネフィク",
            de: "Harmonischer Orbis",
            fr: "Bienfaisance aspectée",
        },
        (63, 17805) => LocalisedText {
            en: "Malefic IV",
            ja: "マレフィジャ",
            de: "Spannungsaspekt IV",
            fr: "Malfaisance IV",
        },
        (63, 17806) => LocalisedText {
            en: "Combust III",
            ja: "コンバガ",
            de: "Konjunktion III",
            fr: "Conjonction supérieure III",
        },
        (63, 17807) => LocalisedText {
            en: "Gravity",
            ja: "グラビデ",
            de: "Gravitas",
            fr: "Gravité",
        },
        (63, 17809) => LocalisedText {
            en: "Neutral Sect",
            ja: "ニュートラルセクト",
            de: "Neutral",
            fr: "Adepte de la neutralité",
        },
        (63, 17824) => LocalisedText {
            en: "Technical Step",
            ja: "テクニカルステップ",
            de: "Komplexe Choreographie",
            fr: "Pas technique",
        },
        (63, 17825) => LocalisedText {
            en: "Technical Finish",
            ja: "テクニカルフィニッシュ",
            de: "Komplexes Finale",
            fr: "Final technique",
        },
        (63, 17832) => LocalisedText {
            en: "Protect",
            ja: "プロテス",
            de: "Protes",
            fr: "Bouclier",
        },
        (63, 17866) => LocalisedText {
            en: "Reprisal",
            ja: "リプライザル",
            de: "Reflexion",
            fr: "Rétorsion",
        },
        (63, 17889) => LocalisedText {
            en: "Nascent Flash",
            ja: "原初の猛り",
            de: "Urflackern",
            fr: "Exaltation naissante",
        },
        (63, 17890) => LocalisedText {
            en: "Draw and Junction",
            ja: "ブラッドドロー",
            de: "Blut-Erda",
            fr: "Giclée de sang",
        },
        (63, 17891) => LocalisedText {
            en: "Aurora",
            ja: "オーロラ",
            de: "Aurora",
            fr: "Aurore",
        },
        (63, 17990) => LocalisedText {
            en: "Dissipation",
            ja: "転化",
            de: "Dissipation",
            fr: "Dissipation",
        },
        (63, 17991) => LocalisedText {
            en: "Celestial Opposition",
            ja: "星天対抗",
            de: "Opposition",
            fr: "Opposition céleste",
        },
        (63, 18899) => LocalisedText {
            en: "Glory Slash",
            ja: "グローリースラッシュ",
            de: "Prunkhieb",
            fr: "Lacération glorieuse",
        },
        (63, 18900) => LocalisedText {
            en: "Total Eclipse",
            ja: "トータルエクリプス",
            de: "Eklipse",
            fr: "Éclipse totale",
        },
        (63, 18901) => LocalisedText {
            en: "Prominence",
            ja: "プロミネンス",
            de: "Protuberanz",
            fr: "Évidence",
        },
        (63, 18902) => LocalisedText {
            en: "Shield Lob",
            ja: "シールドロブ",
            de: "Schildwurf",
            fr: "Lancer de bouclier",
        },
        (63, 18904) => LocalisedText {
            en: "Mythril Tempest",
            ja: "ミスリルテンペスト",
            de: "Mithril-Gewitter",
            fr: "Tempête de mithril",
        },
        (63, 18905) => LocalisedText {
            en: "Steel Cyclone",
            ja: "スチールサイクロン",
            de: "Kreiselklinge",
            fr: "Cyclone de fer",
        },
        (63, 18906) => LocalisedText {
            en: "Unleash",
            ja: "アンリーシュ",
            de: "Entfesselung",
            fr: "Déchaînement",
        },
        (63, 18907) => LocalisedText {
            en: "Stalwart Soul",
            ja: "ストルワートソウル",
            de: "Seelenstärke",
            fr: "Noirceur insoumise",
        },
        (63, 18908) => LocalisedText {
            en: "Flood of Shadow",
            ja: "漆黒の波動",
            de: "Schattenflut",
            fr: "Déluge d'ombre",
        },
        (63, 18909) => LocalisedText {
            en: "Dark Missionary",
            ja: "ダークミッショナリー",
            de: "Dunkler Bote",
            fr: "Missionnaire des Ténèbres",
        },
        (63, 18910) => LocalisedText {
            en: "Demon Slice",
            ja: "デーモンスライス",
            de: "Dämonenschnitter",
            fr: "Tranchage démoniaque",
        },
        (63, 18911) => LocalisedText {
            en: "Demon Slaughter",
            ja: "デーモンスローター",
            de: "Dämonenschlachter",
            fr: "Massacre démoniaque",
        },
        (63, 18913) => LocalisedText {
            en: "Rockbreaker",
            ja: "地烈斬",
            de: "Erdspaltung",
            fr: "Briseur de rocs",
        },
        (63, 18914) => LocalisedText {
            en: "Four-point Fury",
            ja: "四面脚",
            de: "Vierfaches Verhängnis",
            fr: "Furie cardinale",
        },
        (63, 18915) => LocalisedText {
            en: "Brotherhood",
            ja: "桃園結義",
            de: "Bruderschaft",
            fr: "Fraternité",
        },
        (63, 18916) => LocalisedText {
            en: "Raiden Thrust",
            ja: "竜眼雷電",
            de: "Überfallsstoß",
            fr: "Percée Raiden",
        },
        (63, 18917) => LocalisedText {
            en: "Doom Spike",
            ja: "ドゥームスパイク",
            de: "Schicksalsdorn",
            fr: "Pointe du destin",
        },
        (63, 18918) => LocalisedText {
            en: "Sonic Thrust",
            ja: "ソニックスラスト",
            de: "Schallspitze",
            fr: "Percée sonique",
        },
        (63, 18919) => LocalisedText {
            en: "Coerthan Torment",
            ja: "クルザントーメント",
            de: "Coerthische Folter",
            fr: "Tourment du Coerthas",
        },
        (63, 18920) => LocalisedText {
            en: "Life Surge",
            ja: "ライフサージ",
            de: "Vitalwallung",
            fr: "Souffle de vie",
        },
        (63, 18921) => LocalisedText {
            en: "Death Blossom",
            ja: "血花五月雨",
            de: "Todesblüte",
            fr: "Roseraie fatale",
        },
        (63, 18922) => LocalisedText {
            en: "Hakke Mujinsatsu",
            ja: "八卦無刃殺",
            de: "Hakke Mujinsatsu",
            fr: "Hakke Mujinsatsu",
        },
        (63, 18926) => LocalisedText {
            en: "Mangetsu",
            ja: "満月",
            de: "Mangetsu",
            fr: "Mangetsu",
        },
        (63, 18927) => LocalisedText {
            en: "Oka",
            ja: "桜花",
            de: "Oka",
            fr: "Ôka",
        },
        (63, 18928) => LocalisedText {
            en: "Recuperate",
            ja: "快気",
            de: "Genesung",
            fr: "Rétablissement",
        },
        (63, 18929) => LocalisedText {
            en: "Shoha",
            ja: "照破",
            de: "Shoha",
            fr: "Shôha",
        },
        (63, 18930) => LocalisedText {
            en: "Quick Nock",
            ja: "クイックノック",
            de: "Pfeilsalve",
            fr: "Salve fulgurante",
        },
        (63, 18931) => LocalisedText {
            en: "Shadowbite",
            ja: "シャドウバイト",
            de: "Schattenbiss",
            fr: "Morsure de l'ombre",
        },
        (63, 18932) => LocalisedText {
            en: "Spread Shot",
            ja: "スプレッドショット",
            de: "Splitterschuss",
            fr: "Tir dispersé",
        },
        (63, 18933) => LocalisedText {
            en: "Gauss Round",
            ja: "ガウスラウンド",
            de: "Gauß-Geschoss",
            fr: "Décharge Gauss",
        },
        (63, 18934) => LocalisedText {
            en: "Tactician",
            ja: "タクティシャン",
            de: "Taktiker",
            fr: "Tacticien",
        },
        (63, 18935) => LocalisedText {
            en: "Thunder II",
            ja: "サンダラ",
            de: "Blitzra",
            fr: "Extra Foudre",
        },
        (63, 18936) => LocalisedText {
            en: "Thunder IV",
            ja: "サンダジャ",
            de: "Blitzka",
            fr: "Giga Foudre",
        },
        (63, 18937) => LocalisedText {
            en: "Outburst",
            ja: "アウトバースト",
            de: "Elementarkorona",
            fr: "Fracas élémentaire",
        },
        (63, 18938) => LocalisedText {
            en: "Painflare",
            ja: "ペインフレア",
            de: "Schmerzensflare",
            fr: "Brasier de peine",
        },
        (63, 18939) => LocalisedText {
            en: "Bane",
            ja: "ベイン",
            de: "Bann",
            fr: "Fléau",
        ...
        (63, 18941) => LocalisedText {
            en: "Divination",
            ja: "ディヴィネーション",
            de: "Weissagung",
            fr: "Divination",
        },
        (63, 18942) => LocalisedText {
            en: "Bolt",
            ja: "疾走",
            de: "Laufschritt",
            fr: "Galopade",
        },
        (63, 18943) => LocalisedText {
            en: "Medical Kit",
            ja: "軍用ポーション",
            de: "Frontentrank",
            fr: "Potion militaire",
        },
        (63, 18944) => LocalisedText {
            en: "Enchanted Moulinet",
            ja: "エンムーリネ",
            de: "Magischer Moulinet",
            fr: "Moulinet enchanté",
        },
        (63, 18945) => LocalisedText {
            en: "Medica",
            ja: "メディカ",
            de: "Reseda",
            fr: "Médica",
        },
        (63, 18946) => LocalisedText {
            en: "Afflatus Rapture",
            ja: "ハート・オブ・ラプチャー",
            de: "Afflatus laetitiae",
            fr: "Offrande de ravissement",
        },
        (63, 18947) => LocalisedText {
            en: "Succor",
            ja: "士気高揚の策",
            de: "Kurieren",
            fr: "Traité du soulagement",
        },
        (63, 18948) => LocalisedText {
            en: "Indomitability",
            ja: "不撓不屈の策",
            de: "Unbezwingbarkeit",
            fr: "Traité de la persévérance",
        },
        (63, 18949) => LocalisedText {
            en: "Excogitation",
            ja: "深謀遠慮の策",
            de: "Weise Voraussicht",
            fr: "Traité de l'excogitation",
        },
        (63, 18950) => LocalisedText {
            en: "Helios",
            ja: "ヘリオス",
            de: "Helios",
            fr: "Hélios",
        },
        (63, 18951) => LocalisedText {
            en: "Aspected Helios",
            ja: "アスペクト・ヘリオス",
            de: "Aspektierter Helios",
            fr: "Hélios aspecté",
        },
        (63, 18952) => LocalisedText {
            en: "Weapon Throw",
            ja: "ウェポンスロー",
            de: "Waffenwurf",
            fr: "Jet d'arme",
        },
        (63, 18953) => LocalisedText {
            en: "Tri-disaster",
            ja: "トライディザスター",
            de: "Trisaster",
            fr: "Tri-désastre",
        },
        (63, 18954) => LocalisedText {
            en: "Feint",
            ja: "牽制",
            de: "Zermürben",
            fr: "Restreinte",
        },
        (63, 18955) => LocalisedText {
            en: "Concentrate",
            ja: "集中",
            de: "Konzentration",
            fr: "Concentration",
        },
        (63, 18956) => LocalisedText {
            en: "Aetheric Burst",
            ja: "エーテルバースト",
            de: "Ätherschub",
            fr: "Explosion éthérée",
        },
        (63, 18957) => LocalisedText {
            en: "Largesse",
            ja: "慈愛",
            de: "Huld",
            fr: "Largesse",
        },
        (63, 18987) => LocalisedText {
            en: "Ill Wind",
            ja: "辻風",
            de: "Tsujikaze",
            fr: "Vent mauvais",
        },
        (63, 18988) => LocalisedText {
            en: "Hissatsu: Kyuten",
            ja: "必殺剣・九天",
            de: "Hissatsu: Kyuten",
            fr: "Hissatsu : Kyûten",
        },
        (63, 18990) => LocalisedText {
            en: "Retaliation",
            ja: "逆襲",
            de: "Gegenangriff",
            fr: "Vengeance",
        },
        (63, 18992) => LocalisedText {
            en: "Smite",
            ja: "スマイト",
            de: "Zerschlagung",
            fr: "Frappe féroce",
        },
        (63, 18993) => LocalisedText {
            en: "Windmill",
            ja: "ウィンドミル",
            de: "Windmühle",
            fr: "Moulin à vent",
        },
        (63, 18994) => LocalisedText {
            en: "Bladeshower",
            ja: "ブレードシャワー",
            de: "Klingenflut",
            fr: "Averse de lames",
        },
        (63, 18995) => LocalisedText {
            en: "Rising Windmill",
            ja: "ライジングウィンドミル",
            de: "Steigende Windmühle",
            fr: "Moulin à vent ascendant",
        },
        (63, 18996) => LocalisedText {
            en: "Bloodshower",
            ja: "ブラッドシャワー",
            de: "Blutklingen",
            fr: "Averse de sang",
        },
        (63, 18997) => LocalisedText {
            en: "Fan Dance II",
            ja: "扇の舞い【破】",
            de: "Fächertanz II",
            fr: "Danse de l'éventail II",
        },
        (63, 19071) => LocalisedText {
            en: "Nature's Minne",
            ja: "地神のミンネ",
            de: "Nophicas Minne",
            fr: "Minne de la nature",
        },
        (63, 19085) => LocalisedText {
            en: "Intervention",
            ja: "インターベンション",
            de: "Intervention",
            fr: "Intervention",
        },
        (63, 19086) => LocalisedText {
            en: "Testudo",
            ja: "テストゥド",
            de: "Testudo",
            fr: "Testudo",
        },
        (63, 20106) => LocalisedText {
            en: "Embolden",
            ja: "エンボルデン",
            de: "Ermutigen",
            fr: "Enhardissement",
        ...
        (67, 7) => LocalisedText {
            en: "Snap Punch Combo",
            ja: "コンボ：崩拳",
            de: "Kombo Peitschenhieb",
            fr: "Combo Coup de poing brusque",
        },
        (67, 9) => LocalisedText {
        ...
        (67, 18) => LocalisedText {
            en: "Heated Clean Shot Combo",
            ja: "コンボ：ヒートクリーンショット",
            de: "Kombo Sauberer Höllenschuss",
            fr: "Combo Tir net chauffé",
        },
        (67, 19) => LocalisedText {
            en: "Enchanted Redoublement Combo",
            ja: "コンボ：エンルドゥブルマン",
            de: "Kombo Magisches Redoublement",
            fr: "Combo Redoublement enchanté",
        },
        (67, 20) => LocalisedText {
        ...
        (67, 21) => LocalisedText {
            en: "Wicked Talon Combo",
            ja: "コンボ：ウィケッドタロン",
            de: "Kombo Tückische Kralle",
            fr: "Combo Serre vicieuse",
        },
        (67, 22) => LocalisedText {
            en: "Fountain Combo",
            ja: "コンボ：ファウンテン",
        ...
        (67, 27) => LocalisedText {
            en: "Prominence Combo",
            ja: "コンボ：プロミネンス",
            de: "Kombo Protuberanz",
            fr: "Combo Évidence",
        },
        (67, 28) => LocalisedText {
            en: "Steel Cyclone Combo",
            ja: "コンボ：スチールサイクロン",
            de: "Kombo Kreiselklinge",
            fr: "Combo Cyclone de fer",
        },
        (67, 29) => LocalisedText {
            en: "Stalwart Soul Combo",
            ja: "コンボ：ストルワートソウル",
            de: "Kombo Seelenstärke",
            fr: "Combo Noirceur insoumise",
        },
        (67, 30) => LocalisedText {
            en: "Rockbreaker Combo",
            ja: "コンボ：地烈斬",
            de: "Kombo Erdspaltung",
            fr: "Combo Briseur de rocs",
        },
        (67, 31) => LocalisedText {
            en: "Coerthan Torment Combo",
            ja: "コンボ：クルザントーメント",
            de: "Kombo Coerthische Folter",
            fr: "Combo Tourment du Coerthas",
        },
        (67, 32) => LocalisedText {
            en: "Hakke Mujinsatsu Combo",
            ja: "コンボ：八卦無刃殺",
            de: "Kombo Hakke Mujinsatsu",
            fr: "Combo Hakke Mujinsatsu",
        },
        (67, 33) => LocalisedText {
            en: "Kasha Combo",
            ja: "コンボ：花車",
        ...
        (67, 35) => LocalisedText {
            en: "Demon Slaughter Combo",
            ja: "コンボ：デーモンスローター",
            de: "Kombo Dämonenschlachter",
            fr: "Combo Massacre démoniaque",
        },
        (67, 36) => LocalisedText {
            en: "Bladeshower Combo",
            ja: "コンボ：ブレードシャワー",
            de: "Kombo Klingenflut",
            fr: "Combo Averse de lames",
        },
