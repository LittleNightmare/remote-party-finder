...
lazy_static::lazy_static! {
    pub static ref AUTO_TRANSLATE: HashMap<(u32, u32), LocalisedText> = maplit::hashmap! {
        ...
        (63, 27795) => LocalisedText {
            en: "Slice",
            ja: "スライス",
            de: "Schlitzer",
            fr: "Tranchage",
        },
        (63, 27796) => LocalisedText {
            en: "Waxing Slice",
            ja: "ワクシングスライス",
            de: "Neulicht-Schlitzer",
            fr: "Tranchage blafard",
        },
        (63, 27797) => LocalisedText {
            en: "Infernal Slice",
            ja: "インファナルスライス",
            de: "Infernalischer Schlitzer",
            fr: "Tranchage infernal",
        },
        (63, 27798) => LocalisedText {
            en: "Gibbet",
            ja: "ジビトゥ",
            de: "Richtpfahl",
            fr: "Gibet",
        },
        (63, 27799) => LocalisedText {
            en: "Gallows",
            ja: "ギャロウズ",
            de: "Galgen",
            fr: "Potence",
        },
        (63, 27800) => LocalisedText {
            en: "Void Reaping",
            ja: "ヴォイドリーパー",
            de: "Nichtsmäher",
            fr: "Fauchage du néant",
        },
        (63, 27801) => LocalisedText {
            en: "Cross Reaping",
            ja: "クロスリーパー",
            de: "Kreuzmäher",
            fr: "Fauchage croisé",
        },
        (63, 27802) => LocalisedText {
            en: "Spinning Scythe",
            ja: "スピニングサイズ",
            de: "Sichelwirbel",
            fr: "Faux tournoyante",
        },
        (63, 27803) => LocalisedText {
            en: "Nightmare Scythe",
            ja: "ナイトメアサイズ",
            de: "Schneidender Albtraum",
            fr: "Faux cauchemardesque",
        },
        (63, 27804) => LocalisedText {
            en: "Guillotine",
            ja: "ギロティン",
            de: "Guillotine",
            fr: "Guillotine",
        },
        (63, 27805) => LocalisedText {
            en: "Grim Reaping",
            ja: "グリムリーパー",
            de: "Gevatters Schnitt",
            fr: "Fauchage sinistre",
        },
        (63, 27806) => LocalisedText {
            en: "Harpe",
            ja: "ハルパー",
            de: "Harpe",
            fr: "Harpé",
        },
        (63, 27807) => LocalisedText {
            en: "Communio",
            ja: "コムニオ",
            de: "Communio",
            fr: "Communio",
        },
        (63, 27808) => LocalisedText {
            en: "Soul Slice",
            ja: "ソウルスライス",
            de: "Seelenschlitzer",
            fr: "Tranchage animique",
        },
        (63, 27809) => LocalisedText {
            en: "Soul Scythe",
            ja: "ソウルサイズ",
            de: "Seelensense",
            fr: "Faux animique",
        },
        (63, 27810) => LocalisedText {
            en: "Blood Stalk",
            ja: "ストークスウェーズ",
            de: "Knochengarbe",
            fr: "Fétu ensanglanté",
        },
        (63, 27811) => LocalisedText {
            en: "Unveiled Gibbet",
            ja: "ジビトゥクロウ",
            de: "Richtergriff",
            fr: "Gibet suppliciant",
        },
        (63, 27812) => LocalisedText {
            en: "Unveiled Gallows",
            ja: "ギャロウズクロウ",
            de: "Galgengriff",
            fr: "Potence suppliciante",
        },
        (63, 27813) => LocalisedText {
            en: "Grim Swathe",
            ja: "シーフスウェーズ",
            de: "Nachtschwad",
            fr: "Andain sinistre",
        },
        (63, 27814) => LocalisedText {
            en: "Gluttony",
            ja: "グラトニー",
            de: "Völlerei",
            fr: "Gloutonnerie",
        },
        (63, 27815) => LocalisedText {
            en: "Lemure's Slice",
            ja: "レムールスライス",
            de: "Lemurenschlitzer",
            fr: "Tranchage du lémure",
        },
        (63, 27816) => LocalisedText {
            en: "Lemure's Scythe",
            ja: "レムールサイズ",
            de: "Lemurensense",
            fr: "Faux du lémure",
        },
        (63, 27817) => LocalisedText {
            en: "Hell's Ingress",
            ja: "ヘルズイングレス",
            de: "Höllischer Auftritt",
            fr: "Intrusion de l'enfer",
        },
        (63, 27818) => LocalisedText {
            en: "Hell's Egress",
            ja: "ヘルズイーグレス",
            de: "Höllischer Abgang",
            fr: "Retraite de l'enfer",
        },
        (63, 27819) => LocalisedText {
            en: "Regress",
            ja: "リターン",
            de: "Rückkehr",
            fr: "Repli",
        },
        (63, 27820) => LocalisedText {
            en: "Arcane Crest",
            ja: "アルケインクレスト",
            de: "Arkanes Wappen",
            fr: "Blason arcanique",
        },
        (63, 27821) => LocalisedText {
            en: "Enshroud",
            ja: "レムールシュラウド",
            de: "Lemurenschleier",
            fr: "Linceul du lémure",
        },
        (63, 27822) => LocalisedText {
            en: "Dosis III",
            ja: "ドシスIII",
            de: "Dosis III",
            fr: "Dosis III",
        },
        (63, 27823) => LocalisedText {
            en: "Eukrasian Dosis III",
            ja: "エウクラシア・ドシスIII",
            de: "Eukratische Dosis III",
            fr: "Dosis eucrasique III",
        },
        (63, 27824) => LocalisedText {
            en: "Diagnosis",
            ja: "ディアグノシス",
            de: "Diagnose",
            fr: "Diagnosis",
        },
        (63, 27825) => LocalisedText {
            en: "Eukrasian Diagnosis",
            ja: "エウクラシア・ディアグノシス",
            de: "Eukratische Diagnose",
            fr: "Diagnosis eucrasique",
        },
        (63, 27826) => LocalisedText {
            en: "Prognosis",
            ja: "プログノシス",
            de: "Prognose",
            fr: "Prognosis",
        },
        (63, 27827) => LocalisedText {
            en: "Eukrasian Prognosis",
            ja: "エウクラシア・プログノシス",
            de: "Eukratische Prognose",
            fr: "Prognosis eucrasique",
        },
        (63, 27828) => LocalisedText {
            en: "Eukrasia",
            ja: "エウクラシア",
            de: "Eukrasie",
            fr: "Eukrasia",
        },
        (63, 27829) => LocalisedText {
            en: "Phlegma III",
            ja: "フレグマIII",
            de: "Phlegma III",
            fr: "Phlegma III",
        },
        (63, 27830) => LocalisedText {
            en: "Pneuma",
            ja: "プネウマ",
            de: "Pneuma",
            fr: "Pneuma",
        },
        (63, 27831) => LocalisedText {
            en: "Druochole",
            ja: "ドルオコレ",
            de: "Druochole",
            fr: "Druochole",
        },
        (63, 27832) => LocalisedText {
            en: "Ixochole",
            ja: "イックソコレ",
            de: "Ixochole",
            fr: "Ixochole",
        },
        (63, 27833) => LocalisedText {
            en: "Haima",
            ja: "ハイマ",
            de: "Haima",
            fr: "Haima",
        },
        (63, 27834) => LocalisedText {
            en: "Icarus",
            ja: "イカロス",
            de: "Ikarus",
            fr: "Ikaros",
        },
        (63, 27835) => LocalisedText {
            en: "Kardia",
            ja: "カルディア",
            de: "Kardia",
            fr: "Kardia",
        ...
        (67, 49) => LocalisedText {
            en: " Nightmare Scythe Combo",
            ja: "コンボ：ナイトメアサイズ",
            de: "Kombo Schneidender Albtraum",
            fr: "Combo Faux cauchemardesque",
        },
