...
impl DutyCategory {
    pub fn from_u32(u: u32) -> Option<Self> {
        Some(match u {
            ...
            256 => Self::GoldSaucer,
            512 => Self::Fate,
            1024 => Self::TreasureHunt,
            2048 => Self::TheHunt,
            4096 => Self::GatheringForays,
            8192 => Self::DeepDungeon,
            16384 => Self::FieldOperation,
            32768 => Self::VariantAndCriterionDungeon,
            _ => return None,
        })
    }
    ...
    pub fn as_u32(&self) -> u32 {
        match self {
            ...
            Self::GoldSaucer => 256,
            Self::Fate => 512,
            Self::TreasureHunt => 1024,
            Self::TheHunt => 2048,
            Self::GatheringForays => 4096,
            Self::DeepDungeon => 8192,
            Self::FieldOperation => 16384,
            Self::VariantAndCriterionDungeon => 32768,
            _ => 0,
        }
    }
